...
namespace LazyApiPack.XmlTools.Zip.Tests.Tests {
    public class ZipSerializerMultipleClassesTests {
        ...
        public void Setup() {
            ...
            model1.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample1.jpg")));
            model1.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample2.jpg")));
            model1.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample3.jpg")));
            model1.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample4.jpg")));
            model1.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample1.jpg")));
            model1.MainImage = new ZipResource(ValidationHelper.GetResource("Sample4.jpg"));
            _models.Add(model1);
            var model2 = new ImageModel();
            model2.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample3.jpg")));
            model2.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample2.jpg")));
            model2.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample3.jpg")));
            model2.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample3.jpg")));
            model2.Images.Add(new ZipResource(ValidationHelper.GetResource("Sample1.jpg")));
            model2.MainImage = new ZipResource(ValidationHelper.GetResource("Sample2.jpg"));
            _models.Add(model2);
